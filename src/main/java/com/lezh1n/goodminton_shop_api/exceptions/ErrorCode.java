...
public enum ErrorCode {
    ...
    ORDER_CANNOT_CANCEL(2506, "Không thể huỷ đơn hàng ở trạng thái hiện tại", HttpStatus.BAD_REQUEST),
    ORDER_FORBIDDEN(2507, "Không có quyền truy cập đơn hàng này", HttpStatus.FORBIDDEN),
    ORDER_ITEMS_REQUIRED(2508, "Đơn hàng phải có ít nhất 1 sản phẩm", HttpStatus.BAD_REQUEST),
    ORDER_RECIPIENT_NAME_REQUIRED(2509, "Tên người nhận không được để trống", HttpStatus.BAD_REQUEST),
    ORDER_RECIPIENT_PHONE_REQUIRED(2510, "SĐT người nhận không được để trống", HttpStatus.BAD_REQUEST),
    ORDER_RECIPIENT_ADDRESS_REQUIRED(2511, "Địa chỉ người nhận không được để trống", HttpStatus.BAD_REQUEST),
    ORDER_RECIPIENT_EMAIL_INVALID(2512, "Email người nhận không hợp lệ", HttpStatus.BAD_REQUEST),
    ORDER_PAYMENT_METHOD_REQUIRED(2513, "Phương thức thanh toán không được để trống", HttpStatus.BAD_REQUEST),
    ORDER_CUSTOMER_REQUIRED(2514, "Customer ID không được để trống", HttpStatus.BAD_REQUEST),
    ORDER_SHIPPING_CODE_REQUIRED(2515, "Mã vận đơn không được để trống", HttpStatus.BAD_REQUEST),
    ORDER_ITEM_VARIANT_REQUIRED(2516, "Variant ID không được để trống", HttpStatus.BAD_REQUEST),
    ORDER_ITEM_QUANTITY_REQUIRED(2517, "Số lượng không được để trống", HttpStatus.BAD_REQUEST),
    ORDER_ITEM_QUANTITY_INVALID(2518, "Số lượng phải lớn hơn 0", HttpStatus.BAD_REQUEST),
